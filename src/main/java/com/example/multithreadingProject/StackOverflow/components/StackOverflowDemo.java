...
import com.example.multithreadingProject.StackOverflow.models.Answer;
import com.example.multithreadingProject.StackOverflow.models.Question;
import com.example.multithreadingProject.StackOverflow.models.Tag;
import com.example.multithreadingProject.StackOverflow.models.User;
...
public class StackOverflowDemo {
    public static void run() {
        ...
        System.out.println("Tags: " + javaQuestion.getTags().stream().map(Tag::getValue).reduce((a, b) -> a + ", " + b).orElse(""));
